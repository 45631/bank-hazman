      ...
      <div>
        ...
        <div className="container">
          ...
          <p className="p1">
            ...
            <br />
            בבנק הזמן שותפים משתמשים רבים. לכל משתמש חשבון עו"ש, ממש כבכל בנק
            אחר, אך בבנק הזמן המטבע העובר לסוחר הנו - זמן, במטבעות של שעות.
          </p>
          <br />
          <p className="p2">
            ...
            האישיים שלו.
            <br /> לתשומת לב - מכירת שירותים בתמורה לתשלום בכסף "אמיתי" אסורה
            בבנק הזמן!
          </p>
          <p>דף חשבון לדוגמא:</p>
          <img />
